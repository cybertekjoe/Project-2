...
Read through the [Documentation](https://github.com/aprilemorales/RedvsBlueProject/tree/master/Documentation) to view work, proccess, notes and findings from both [Red Team](https://github.com/aprilemorales/RedvsBlueProject/blob/master/Documentation/RedTeam.md) and [Blue Team](https://github.com/aprilemorales/RedvsBlueProject/blob/master/Documentation/BlueTeam.md) perspective that lead up to creation of the final presetation.
